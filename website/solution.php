		...
		<!---start-wrap---->
			...
			<div class="content">
				<div class="wrap">
					...
					<div class="gallery-grids"id="service-one">
                        <hr class="solution">
                        <div class="gallery-grid"  style="margin:4%;height:200px;">
		          		<div style="width:38%;float:right;">
							<a href=""><br><img class="solution" src="./images/people.jpg" alt=""></a>
						</div>
						<div style="width:60%;float:left;">
							<strong><font style="font-weight:bold;"size="5">Wireless Solutions</font></strong><br></br>
							<p class = "detail">The proliferaton of wireless networks has placed in increased demands on carriers, whireless professionals and contractors, who install, maintain and troubleshoot wireless communication networks. The majority of problems in wireless network installation and performance often occur within the base station infrastructure, which consists of the cable and antenna system and associated RF connectors.</p>
						</div>
						</div>
						<hr class="solution">
		          		<div class="gallery-grid"  style="margin-top:4%;margin-bottom:4%;height:180px;">
		          		<div style="width:30%;float:left;">
							<a href=""><img class="solutions" src="./images/2869110.jpg" alt=""></a>
						</div>
						<div style="width:70%;float:right;">
							<strong><font style="font-weight:bold;"size="3">E7000A Cable Analyzer</font></strong>
							<br></br>
							<p class = "detail">The E7000 Series of Cable&Antenna Analyzers provide all of the necessary measurement functions and preformance to accurately diagnose and verify the site's calbe feedline, connectors and antenna system, including signal reflections(return loss or VSWR), fault location(distance to fault),cable loss and RF transimission power in a lightweight, handheld instrument.</p>
						...
						<div style="width:70%;float:right;">
							<strong><font style="font-weight:bold;"size="3">E8000A Spectrum Analyzer</font></strong>
							<br></br>
							<p class = "detail">The E8000 Series of Spectrum Analyzers provide all of the necessary measurement functions and performance to accurately characterize the signal environment in addition to clearing, detecting, identifying and locating signal interference in a lightweight, handheld instrument.</p>
							<p><a class="grid-button" href="#">Read PDF</a></p>
						</div>
						</div>
						<div class="clear"> </div>
